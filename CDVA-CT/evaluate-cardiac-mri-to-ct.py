...
BASE_FID = '../data/cardiac/test_ct_image_and_labels' # folder path of test files
...
class SIFA:
    ...
    def __init__(self, config, keep_rate, ratio):
    ...
    def test(self, weigh, pidx):
        ...
        with tf.Session() as sess:
            ...
            self.checkpoint_pth = '../weights/cardiac/CDVA-CT-mri-to-ct/sifa-'+str(pidx)
...
def main(config_filename):
    ...
    for i in [5]:
        sifa_model = SIFA(config, 1.0, i/10.)
        sifa_model.test(1.0, 19999)


if __name__ == '__main__':
    main(config_filename='./config_param_cardiac.json')
